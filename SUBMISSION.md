...
**Submit at:** [https://cerebralvalley.ai/e/raise-summit-hackathon/hackathon/submit](https://cerebralvalley.ai/e/raise-summit-hackathon/hackathon/submit)  
**Repo (public):** [https://github.com/Rumblingb/raise](https://github.com/Rumblingb/raise)
...
[https://github.com/Rumblingb/raise](https://github.com/Rumblingb/raise)

### Demo / application URL

**Local demo (judges):** clone repo → `node server.mjs` → [http://localhost:8787](http://localhost:8787)  
...
- [x] `cursor-agent login` — Cursor worker green in fleet lane
- [x] Server warmed: `node server.mjs` (Gemma loads at boot)
- [x] Arc verified: `node scripts/verify-arc.mjs`
- [x] 1-min video recorded (Clickey desk visible for gesture moments)
- [ ] Video URL pasted above + in Cerebral Valley form
- [x] Discord joined + remote registration confirmed
- [x] Cursor credits form submitted ($300/dev)
